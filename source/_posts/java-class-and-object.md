...
**默认权限package-private与protected很相似，两者的区别主要体现在当外包想要访问该成员时，y拥有默认权限的成员外包无法访问，而对于protected的方法，只需继承这个方法所在的类，即可访问这个方法.**
...
- 定义成员内部类时，类似于定义类中的成员，可以使用public，protected，private修饰符，这些访问权限修饰符会控制成员内部类的可见性
